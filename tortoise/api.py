...
class TextToSpeech:
    ...
    def tts_with_preset(self, text, preset='fast', **kwargs):
        ...
        settings = {'temperature': .6, 'length_penalty': 1.0, 'repetition_penalty': 2.0,
                    'top_p': .8,
                    'cond_free_k': 2.0, 'diffusion_temperature': 1.0}
        # Presets are defined here.
        presets = {
            'ultra_fast': {'num_autoregressive_samples': 18, 'diffusion_iterations': 20, 'cond_free': True},
            # 'ultra_fast': {'num_autoregressive_samples': 16, 'diffusion_iterations': 30, 'cond_free': True},
            # 'ultra_fast': {'num_autoregressive_samples': 32, 'diffusion_iterations': 50, 'cond_free': True},
